...
export default function AboutUsSection() {
    return (
        <div className=" mx-[25px] flex flex-col justify-center md:flex-row sm:mx-[25px] md:mt-[40px] lg:gap-[120px] py-[10%}">
            <h1 className=" text-[#000000] font-[400] lg:pb-0 pb-9 pl-8 lg:pl-0 lg:hidden lg:pt-0 pt-12 flex text-left text-[24px] sm:text-[64px] dark:text-white">About us</h1>
             <div className="w-[100%] h-[100%] px-5 lg:py-10 flex lg:hidden justify-center items-center md:w-[45%] md:py-[-10%] ">
                <Image
                    src={AboutUsRightImg}
                    alt="aboutUsImg"
            ...
            <div className=" w-[100%] relative px-5 py-5 flex flex-col sm:col-span-4 gap-4 sm:px-[20px] sm:py-[30px] md:w-[45%]">
                ...
                <div className="z-5 relative flex flex-col gap-[30px]">
                    <h1 className=" text-[#000000] lg:flex hidden font-[400] text-left text-[24px] sm:text-[64px] dark:text-white">About us</h1>
                    <div className="flex flex-col gap-[40px]">
                        <p className="text-[#000000] font-[500] pt-14 lg:pt-0 text-left sm:text-[14px] sm:w-[94%] dark:text-[#ffffff]">
            ...
            <div className=" relative w-[100%] h-[100%] px-5 py-10 lg:flex hidden justify-center items-center md:w-[45%] md:py-[-10%] ">
                <Image
                    src={AboutUsRightImg}
                    alt="aboutUsImg"
                    className="border-[6px] rounded-[200px] border-[#ffffff]"
